...
export const explanationCopy: Record<string, string> = {
  ...
  "epsilon.explore": "Exploration: the ε draw selected a random gate.",
  ...
  "epsilon.firstExploration":
    "First definite exploration: the ε draw tested a random gate instead of following the current estimate.",
  ...
  "epsilon.cumulativeRegret":
    "Cumulative expected regret totals the reward probability forgone by every choice in this run.",
  "linucb.decision":
